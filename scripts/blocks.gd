...
var current_health: intvar points: int
							...
							update_appearance()
									...
									# Screen shake effect (simple)
										var tween = create_tween()
											var original_pos = global_position	tween.tween_method(shake_position, 0.0, 1.0, 0.2)
																																																																			...
																																																																			return Color.CYAN	
																																																																				var health_ratio = float(current_health) / float(max_health)
																																																																					if health_ratio > 0.66:
																																																																								return Color.RED	elif health_ratio > 0.33:
																																																																											return Color.ORANGE	else:
																																																																														return Color.YELLOW
